...
try{
  // mongoose.connect(process.env.MONGODB_URL) // real production mode
  mongoose.connect('mongodb://localhost/kanicasino');
} catch (err) {
  console.log('Failed to connect to mongodb. Please check the DB connection.');
  process.exit(1);
}
